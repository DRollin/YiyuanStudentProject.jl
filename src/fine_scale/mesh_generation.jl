...
Return a Grid with spherical inclusions for a 3D Representative Volume Element (RVE) in desired meshsize. 
...
# Variation 1
The grid will be generated by given the volume fraction of the spherical inclusions `ϕ` (0 ≤ `ϕ` ≤ 1),
the average diameter of the spheres `d`, and the `meshsize` as well as the RVE size `dx` 
in 3D, which by default is `(1.0, 1.0, 1.0)`.
