...
dim = 3
P = Material{dim}(; G=4.5e5, K=8.0e5, η=0.5, cʳᵉᶠ=1.0, μʳᵉᶠ=1.0, θʳᵉᶠ=1.0, cᵐ=1.0, α=0.2)
M = Material{dim}(; G=0.8e5, K=1.7e5, η=1.0, cʳᵉᶠ=1.0, μʳᵉᶠ=1.0, θʳᵉᶠ=1.0, cᵐ=1.0, α=0.0)
d = 0.2
ϕ = 0.3
meshsize = 0.1
#
...
res, res_rve, setup = solve_macro_problem(grid_macro, setup_rve, rve, bc, Δt=1e-4, t_total=1e-3)
